--Begin GroupManager.lua By sina
...
if matches[1] == "sudohelp" and is_mod(msg) or  matches[1] == "Sudohelp" and is_mod(msg) or  matches[1] == "راهنما سودو" and is_mod(msg) then
text = [[
⚜*ฬOℓtέЯ TG*
...
if matches[1] == "lockhelp" and is_mod(msg) or matches[1] == "Lockhelp" and is_mod(msg) or matches[1] == "راهنماقفل" and is_mod(msg) then
if not lang then
text = [[
💠*EngliSh CoMmAnDs :*
...
if matches[1] == "modhelp" and is_mod(msg) or matches[1] == "Modhelp" and is_mod(msg) or matches[1] == "راهنما مدیریتی" and is_mod(msg) then
if not lang then
text = [[
💠*EngliSh CoMmAnDs :*
...
if matches[1] == "funhelp" and is_mod(msg) or matches[1] == "Funhelp" and is_mod(msg) or matches[1] == "راهنما فان" and is_mod(msg)  then
if not lang then
text = [[
💠*EngliSh CoMmAnDs :*
